"""
source:
https://github.com/mkara44/transunet_pytorch/blob/929e07b35a9769a7deffc42031322fe722545190/utils/vit.py
"""
import torch
...
class ViT(nn.Module):
    def __init__(
        ...
        self.token_dim = img_ch * (patch_dim**2)
...
class TransformerUNet(nn.Module):
    def __init__(
        ...
        self.encoder = Encoder(
            img_dim, img_ch, channels, head_num, mlp_dim, block_num, patch_dim
        )
        self.decoder = Decoder(channels, output_ch)

    def forward(self, x):
        x = F.pad(input=x, pad=(0, 0, 32, 32), mode="constant", value=0)
...
if __name__ == "__main__":
    ...
    print(transunet(torch.randn(1, 3, 192, 256)).shape)
